...
sudo apt-get install php7.1 php7.1-common php7.1-cli php7.1-fpm php7.1-json php7.1-opcache php7.1-xml --assume-yes
sudo apt-get install libapache2-mod-php7.1 php7.1-mysql php7.1-pgsql php7.1-curl php7.1-dev php7.1-sqlite3 php7.1-mbstring php7.1-gd --assume-yes
...
cho "--- Atualizando lista de pacotes ---"
sudo apt-get update
